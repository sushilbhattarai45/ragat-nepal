...
const FindADonor = ({navigation}) => {
  ...
  React.useEffect(() => {
    const getDonors = async (bloodGroup, address) => {
      setSpinner(true);
      const url = 'https://ragatnepal.com/api/donor.php';
  ...
  return (
    <SafeAreaView
      style={[
        ...
        <Header iconL="chevron-left" headerText="Find A Donor" onPressL={navigation.goBack} />
              <ScrollView showsVerticalScrollIndicator={false}>

        <Input placeholder="Address (District City)" icon="map-marker" onChangeText={(val)=>{setAddress(val.trim())}} style={{marginVertical:Spacing.m}} />
